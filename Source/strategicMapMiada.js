<html>
	...
	<style type="text/css">
		...
		//option to defineColor get the css style name
			...
			img.onload = function() {
				...
				*/
				...
				for (var i = 0 ; i < totalitems ; i++) {
					...
					childdiv.id = intlid;
					childdiv.onclick = function(){ alert('Selected ItemID:' + this.id );
						/* DrillDown URL */
					...
					//var y = 180  ; // * (Math.PI / 180)) * radius;
					//var x = itemxmap;  * i; //Math.cos((div * i) * (Math.PI / 180)) * radius;
